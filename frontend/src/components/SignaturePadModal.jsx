 ...
 */
export default function SignaturePadModal({ isOpen, onClose, onSave, existingSignature = null }) {
  ...
  useEffect(() => {
    ...
    const resize = () => {
      ...
      if (existingSignature) {
        ...
        img.src = existingSignature.startsWith('data:')
          ? existingSignature
          : `data:image/png;base64,${existingSignature}`;
        setHasDrawn(true);
      }
    };
    resize();
